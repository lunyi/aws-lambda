...
Execute unit tests
```
    cd "serverless-setep-function-hello-world/test/serverless-setep-function-hello-world.Tests"
    dotnet test
```

Deploy application
```
    cd "serverless-setep-function-hello-world/src/serverless-setep-function-hello-world"
